...
function clickOption(){
    ...
    if(child.getElementsByClassName("active_var")[0] != null){
...
function clearConfig(){
  ...
  var variant_name = this.parentElement.parentElement.getElementsByClassName("variant_name_recap").value;
